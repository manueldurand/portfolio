<h2 class="cache media-titre primary">Manuel Durand C.V.</h2>
<section class="cv_part cv_part_1">
...
<section class="cv_part cv_part_2">
    <div class="text">
        ...
        <ul>
            ...
            <li>Compositeur et arrangeur, studio et concerts, musiques et illustrations pour le théâtre.<br>
                Co-directeur musical de stages de musique pour adultes de 2006 à 2022.

            </li>
            <li>Collaborations remarquables :
                <ul>
                    <li class="dms">Neil Conti, (Prefab Sprout, David Bowie, Youssou'N'Dour...)</li>
                    <li class="guit">Keziah Jones</li>
                    <li class="mic">Florent Pagny avec Les Fous Chantants</li>
                </ul>
            </li>
        </ul>
    </div>
    <div class="liens">
        <ul>
            ...
            <li><a href="https://unsoufflesurlepiano.bandcamp.com/" target="_blank">un souffle sur le piano (shop)</a></li>
        </ul>
    </div>
</section>
...
<section class="cv_part competences">
    ...
    <div class="icones">
        <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="50px" height="50px">
                <path fill="#dcd5f2" d="M40,61.5C18.22,61.5,0.5,51.855,0.5,40S18.22,18.5,40,18.5S79.5,28.145,79.5,40S61.78,61.5,40,61.5z" />
                <path fill="#8b75a1" d="M40,19c21.505,0,39,9.421,39,21S61.505,61,40,61S1,51.579,1,40S18.495,19,40,19 M40,18 C17.909,18,0,27.85,0,40s17.909,22,40,22s40-9.85,40-22S62.091,18,40,18L40,18z" />
                <path fill="#36404d" d="M25.112 34c1.725 0 3.214.622 4.084 1.706.749.934.981 2.171.668 3.577C29.023 43.074 27.395 44 21.57 44h-4.14l1.75-10H25.112M25.112 32H17.5L14 52h2l1.056-6h4.515c5.863 0 9.053-.905 10.246-6.284C32.842 35.096 29.436 32 25.112 32L25.112 32zM61.112 34c1.725 0 3.214.622 4.084 1.706.749.934.981 2.171.668 3.577C65.023 43.074 63.395 44 57.57 44h-4.14l1.75-10H61.112M61.112 32H53.5L50 52h2l1.056-6h4.515c5.863 0 9.053-.905 10.246-6.284C68.842 35.096 65.436 32 61.112 32L61.112 32z" />
                <g>
                    <path fill="#36404d" d="M49.072,33.212C48.193,32.348,46.644,32,44.334,32h-5.538L40,26h-2.1L34,46h1.99l2.388-12h0.419 h5.538c2.338,0,3.094,0.4,3.335,0.637c0.343,0.338,0.424,1.226,0.217,2.363l-1.767,9h2.106l1.626-8.63 C50.199,35.462,49.936,34.062,49.072,33.212z" />
                </g>
            </svg></div>

        <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256" width="50px" height="50px" fill-rule="nonzero">
                <g fill="#00f7ff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
